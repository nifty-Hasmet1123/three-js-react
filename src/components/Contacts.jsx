            ...
            <div className="contacts-container">
                <div id="left-contacts">
                    <form ref={ref} onSubmit={handleSubmit} id="form-contacts">
                        <h1 id="title-contacts">Contact Us</h1>
                        <input name="name" type="text" className="input-contacts" placeholder="Name"/>
                        <input name="email" type="text" className="input-contacts" placeholder="Email"/>
                        <textarea
                        name="message" 
                        id="textarea" 
                        rows="10" 
